...
&
A predefined error handler that returns from \openshmem operations at the \ac{PE}.
\tabularnewline \hline
%%
\LibConstDecl{SHMEM\_ERRHANDLER\_GBREAK}
& 
A predefined error handler that returns from \openshmem operations at all \acp{PE}.
\tabularnewline \hline
%%
\end{longtable}
