...
\begin{apiarguments}
    ...
    \apiargument{IN}{user_context}{An application parameter passed to the error handler
...
\apidescription{
    ...
    is called, with the error code, and the provided \textit{user_context} as arguments. 
    ...
    in which case the \textit{user_context} argument is ignored), 
